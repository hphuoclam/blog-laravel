		...
		<form class="form-horizontal" action="/blog/{{ $blog->id }}" method="POST">
			...
			<fieldset>
				...
				<div class="form-group {{ $errors->has('short_content') ? ' has-error' : '' }}">
					...
					<div class="col-lg-10">
						<textarea class="form-control" rows="3" name="short_content" placeholder="Content short">{{ $blog->short_content }}</textarea>
				...
				<div class="form-group {{ $errors->has('content') ? ' has-error' : '' }}">
					...
					<div class="col-lg-10">
						<textarea class="form-control" rows="10" name="content" placeholder="Content">{{ $blog->content }}</textarea>
